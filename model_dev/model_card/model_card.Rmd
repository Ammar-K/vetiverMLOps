---
title: "Model Card: Flights model"
date: '`r Sys.Date()`'
output: 
  html_document
params:
...
- Developed by `r v$metadata$user$developer` from team `r v$metadata$user$team`
...
- If you have questions about this model, please contact `r v$metadata$user$contact`
...
library(parsnip)
library(workflows)
preds <- augment(v, pins::pin_read(params$board, 'test_data'))
```
